...
//    }
    ...
    public void startup() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[.='GTM City'])[3]")));

        Thread.sleep(300);

        driver.findElement(By.xpath("(//*[.='GTM City'])[3]")).click();
    ...
    @Test(dataProvider = "data")
    public void addmodulecase1(String d1){

        WebElement addbutton=driver.findElement(By.cssSelector("[data-testid='AddIcon']"));

        addbutton.click();

        WebElement GTMVISBILE=driver.findElement(By.xpath("(//*[@data-shrink='true'])[1]"));

        Assert.assertTrue(GTMVISBILE.isDisplayed());

        WebElement GtmCity= driver.findElement(By.name("gtmCity"));
    ...
    public void addmodulecase2(String d1){
        ...
        WebElement GtmCityDesc= driver.findElement(By.name("gtmCityDescription"));

        GtmCityDesc.click();

        GtmCityDesc.sendKeys(d1);

    }


    @Test(dataProvider = "data2")
    public void addmodulecase3(String d1,String d2) {
