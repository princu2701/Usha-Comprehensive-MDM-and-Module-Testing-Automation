...
//    }
    ...
    public void startup() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[.='Distribution Channel'])[3]")));

        Thread.sleep(300);

        driver.findElement(By.xpath("(//*[.='Distribution Channel'])[3]")).click();
    ...
    @Test(dataProvider = "data")
    public void addnewmodulecase2(String fetches) throws InterruptedException {
        ...
        WebElement desc = driver.findElement(By.cssSelector("[name='distributionChannelDescription']"));

        desc.click();

        desc.sendKeys(fetches);
    ...
    public void addnewmodulecase3(String data1,String data2) throws InterruptedException {
