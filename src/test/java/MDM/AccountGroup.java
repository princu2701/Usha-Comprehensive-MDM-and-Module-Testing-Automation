...
public class AccountGroup {
    ...
    public void reports() {
        ...
        reports= new ExtentReports("C:\\Users\\Admin\\Documents\\workspace-spring-tool-suite-4-4.25.0.RELEASE\\UshaProject\\AccountGroupReport1.html");
    ...
    public void startup() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[.='Account Group'])[3]")));

        Thread.sleep(500);

        driver.findElement(By.xpath("(//*[.='Account Group'])[3]")).click();
