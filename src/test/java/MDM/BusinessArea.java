...
public class BusinessArea {
    ...
    public void startup() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[.='Business Area'])[3]")));

        Thread.sleep(500);

        driver.findElement(By.xpath("(//*[.='Business Area'])[3]")).click();
    ...
    public void addmodulecase1(String d1){
        ...
        WebElement addboxbutton=driver.findElement(By.cssSelector("[data-testid='AddIcon']"));

        addboxbutton.click();

        WebElement ba=driver.findElement(By.name("businessArea"));

        ba.sendKeys(d1);

        WebElement desc=driver.findElement(By.name("businessAreaDescription"));
