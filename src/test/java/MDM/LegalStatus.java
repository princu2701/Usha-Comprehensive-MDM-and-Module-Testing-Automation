...
public class LegalStatus {
    ...
    public void startup() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[.='Legal Status'])[3]")));

        Thread.sleep(500);

        driver.findElement(By.xpath("(//*[.='Legal Status'])[3]")).click();
    ...
    public void addmodulecase1() throws InterruptedException {
        ...
        WebElement addmodulebutton=driver.findElement(By.cssSelector("[data-testid='AddIcon']"));

        addmodulebutton.click();

        WebElement pankey=driver.findElement(By.name("panKey"));

        pankey.click();

        wait.until(ExpectedConditions.elementToBeClickable(By.name("legalStatus")));

        WebElement legals=driver.findElement(By.name("legalStatus"));

        legals.click();

        wait.until(ExpectedConditions.elementToBeClickable(By.name("legalStatusDescription")));

        WebElement desc=driver.findElement(By.name("legalStatusDescription"));
        ...
        String assertion=driver.findElement(By.xpath("(//*[.='Legal Status Required'])[1]")).getText();

        Assert.assertEquals(assertion,"Legal Status Required");
    }


    @Test(dataProvider = "data")
    public void addmodulecase2(String d1){
    ...
    @Test(dataProvider = "data")
    public void addmodulecase3(String d1){
    ...
    @Test(dataProvider = "data")
    public void addmodulecase4(String d1){
