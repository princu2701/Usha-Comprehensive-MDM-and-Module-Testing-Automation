...
//        }
    ...
    public void simplescenario1() throws InterruptedException {
        ...
        WebElement domestic=driver.findElement(By.xpath("//li[@id='size-small-filled-option-0']"));
        ...
        WebElement materialname=driver.findElement(By.cssSelector("[title=\"RAAF000004\"]"));
        ...
        Assert.assertTrue(requesttype.contains("Request Type: Domestic"));

        System.out.println("Request Type Length is : "+ requesttype.length());

        WebElement Plantname=driver.findElement(By.cssSelector("[value='USFI']"));

        if ((Plantname.getAttribute("value").equals("USFI"))){
