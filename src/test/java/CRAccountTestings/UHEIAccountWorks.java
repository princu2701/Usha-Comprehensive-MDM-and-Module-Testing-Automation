...
//        }
        ...
        public void simplescenario1() throws InterruptedException {
            ...
            WebElement materialname=driver.findElement(By.xpath("//div[@title='XFAIR00001A']"));
            ...
            WebElement Plantname=driver.findElement(By.cssSelector("[value='UHEI']"));

            if (Plantname.getAttribute("value").equals("UHEI")){
