...
//        }
        ...
        public void simplescenario1() throws InterruptedException {
            ...
            WebElement materialname=driver.findElement(By.xpath("(//div[@title='R6AO200003'])[1]"));
           ...
           WebElement Plantname=driver.findElement(By.cssSelector("[value='UWST']"));

           if (Plantname.getAttribute("value").equals("UWST")){
